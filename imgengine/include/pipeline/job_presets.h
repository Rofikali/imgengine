...
static inline int img_job_template_lookup(
    const char *name,
    img_job_template_t *template_id)
{
    ...
    if (strcmp(name, "passport-45x35") == 0 ||
        strcmp(name, "passport-45x35-printready") == 0)
    {
        *template_id = IMG_JOB_TEMPLATE_PASSPORT_45X35;
        return 0;
    }

    if (strcmp(name, "passport-38x35") == 0 ||
        strcmp(name, "passport-38x35-printready") == 0)
    {
